<template>
  <div class="author-search-results">
    <div class="search-results-header">
      <h2>Результати пошуку авторів за запитом "{{ searchQuery }}"</h2>
      <div class="search-results-actions">
        ...
        <router-link to="/authors/get_all">Список авторів</router-link>
...
.functional-buttons a, .functional-buttons button {
  margin-right: 10px;
  padding: 5px 10px;
  background-color: #337ab7;
  border: none;
...
.functional-buttons a:hover, .functional-buttons button:hover {
  background-color: #286090;
}
